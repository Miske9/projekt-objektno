...
namespace tutorial_wpf
{
    public partial class MainWindow : NavigationWindow
    {
        ...
        public void Window_Load(object sender, RoutedEventArgs e)
        {
            ...
            Match match = new Match(_context.FootballClubs.First(),
            _context.FootballClubs.Local.ToList()[1], "Stadion Suhača", "Champions League");
            match.RecordResult(1, 0, _context.Players.Local.ToList()[0], null);
